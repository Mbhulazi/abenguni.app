...
const ThreadCard = ({
  ...
  return (
    <article className="flex w-full rounded-xl bg-dark-2 p-7">
      <div className="flex items-start justify-between">
        <div className="flex w-full flex-1 flex-row gap-4">
          ...
          <div>
            ...
            <p className="mt2 text-small-regular text-light-2">{content}</p>
            <div className={`$isComment && "mb-10"} mt5 flex flex-col gap-3`}>
